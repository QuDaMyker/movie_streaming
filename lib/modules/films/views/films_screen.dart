                    ...
                    () => filmsController.isLoadingTrending.value
                        ...
                        : SizedBox(
                            ...
                            child: ListView.builder(
                              ...
                              itemCount: filmsController
                                  .listTrendingMovies.value.length,
                              ...
                              itemBuilder: (context, index) {
                                return GestureDetector(
                                  ...
                                  child: ItemMovie(
                                    ...
                                    title: filmsController.listTrendingMovies
                                        .value[index]['title'],
                    ...
                    () => filmsController.isLoadingPopular.value
                        ...
                        : SizedBox(
                            ...
                            child: ListView.builder(
                              physics: const BouncingScrollPhysics(),
                              itemCount: filmsController
                                  .listPopularMovies.value.length,
                              scrollDirection: Axis.horizontal,
                              itemBuilder: (context, index) {
                                return GestureDetector(
                                  onTap: () {
                                  ...
                                  child: ItemMovie(
                                    image: filmsController.listPopularMovies
                                        .value[index]['backdrop_path'],
                                    title: filmsController.listPopularMovies
                                        .value[index]['title'],
                    ...
                    () => filmsController.isLoadingTopRated.value
                        ...
                        : SizedBox(
                            ...
                            child: ListView.builder(
                              physics: const BouncingScrollPhysics(),
                              itemCount: filmsController
                                  .listTopRatedMovies.value.length,
                              scrollDirection: Axis.horizontal,
                              itemBuilder: (context, index) {
                                return GestureDetector(
                                  onTap: () {
                                  ...
                                  child: ItemMovie(
                                    image: filmsController.listTopRatedMovies
                                        .value[index]['backdrop_path'],
                                    title: filmsController.listTopRatedMovies
                                        .value[index]['title'],
                    ...
                    () => filmsController.isLoadingUpcoming.value
                        ...
                        : SizedBox(
                            ...
                            child: ListView.builder(
                              physics: const BouncingScrollPhysics(),
                              itemCount: filmsController
                                  .listUpcomingMovies.value.length,
                              scrollDirection: Axis.horizontal,
                              itemBuilder: (context, index) {
                                return GestureDetector(
                                  onTap: () {
                                  ...
                                  child: ItemMovie(
                                    ...
                                    title: filmsController.listUpcomingMovies
                                        .value[index]['title'],
